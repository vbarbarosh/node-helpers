...
if (typeof window[ns] !== 'undefined') {
    console.log(`❌ @vbarbarosh/node-helpers@${"3.75.0"} was not injected — window.${ns} is already in use`);
}
else {
    console.log(`🎉 @vbarbarosh/node-helpers@${"3.75.0"} successfully exposed as window.${ns}`);
    window[ns] = {};
