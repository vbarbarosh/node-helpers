...
if (typeof window[ns] !== 'undefined') {
    console.log(`❌ @vbarbarosh/node-helpers@${"3.72.1"} was not injected — window.${ns} is already in use`);
}
else {
    console.log(`🎉 @vbarbarosh/node-helpers@${"3.72.1"} successfully exposed as window.${ns}`);
    window[ns] = {};
