vue_component('main-header', {
    template: `
        <div>
            ...
            <div>
                <div class="rel"><copy-to-clipboard value='<script src="https://unpkg.com/@vbarbarosh/node-helpers@3.68.0/dist/browser.js?var=h">&lt;/script>"' /></div>
                <prism-html value='<script src="https://unpkg.com/@vbarbarosh/node-helpers@3.68.0/dist/browser.js?var=h">&lt;/script>' />
            </div>
