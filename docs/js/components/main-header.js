vue_component('main-header', {
    template: `
        <div>
            ...
            <div>
                <div class="rel"><copy-to-clipboard value='<script src="https://unpkg.com/@vbarbarosh/node-helpers@3.70.1/dist/browser.js?var=h">&lt;/script>"' /></div>
                <prism-html value='<script src="https://unpkg.com/@vbarbarosh/node-helpers@3.70.1/dist/browser.js?var=h">&lt;/script>' />
            </div>
